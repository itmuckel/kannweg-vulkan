...
{
    std::ifstream file{filename, std::ios::ate // read from end to determine size in advance
                                     | std::ios::binary};
...
class HelloTriangleApplication
{
  ...
  private:
    ...
    void createSwapChain()
    {
        ...
        // maxImageCount == 0 -> no max image count.
    ...
    void createRenderPass()
    {
        ...
        colorAttachmentRef.attachment = 0; // only the single description defined before, index 0
    ...
    void createCommandBuffers()
    {
        ...
        for (size_t i = 0; i < commandBuffers.size(); i += 1)
        {
            ...
            const VkClearValue clearColor = {0.2f, 0.2f, 0.4f, 1.0f};
